...
def _apply_reasoning_mode(message: str, mode: str, analysis_type: str = "auto") -> str:
    ...
    if actual_mode == "fast":
        parts.append(
            "STYLE RULE — answer like a careful chemist briefing a colleague. Calm, confident, answer-first. "
            "State the answer in the first sentence, grounded in the actual source rows. "
            "No dashboard scaffolding, no consulting-deck language, no buildup. Numbers over adjectives, and every "
            "number must trace to the SQL result. "
            "Do NOT show a SOURCES section in markdown (the [SOURCE:] tag carries it). "
        ...
        parts.append(
            "STYLE RULE — answer like a careful chemist who has done the deeper read. Calm, confident, answer-first. "
            "Lead with the answer, then show the reasoning that earned it, grounded in the actual source rows. "
            "No dashboard scaffolding, no consulting-deck language. Every number has context (vs last period, vs "
            "average, vs total) and traces to the SQL result. Numbers over adjectives. "
            "Do NOT show a SOURCES section in markdown (the [SOURCE:] tag carries it). "
            "Do NOT write 'Related questions'/'Follow-up questions' in markdown — the [RELATED:] tags render as chips. "
            "Emit ONLY the tags below, in this order — nothing else structured: "
            "- [HEADLINE:2-6 word noun-phrase title] — the card title, FIRST line. "
