...
- **Admin console:** `/ui/embed` (super-admin) — **Overview · Brand · Widgets · Monitoring · Usage · Snippet & Docs** (rebuilt 2026-06-09). Clicking a widget opens a **per-widget cockpit** (Appearance · Snippet & Deploy · Share link · Activity + live test) — this replaced the standalone **Playground** tab.
