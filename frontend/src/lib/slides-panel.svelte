...
<div class="slides-panel">
  <header class="sp-header">
    <div class="sp-title">
      <span class="sp-icon"><Icon name="bar-chart" size={16} /></span>
      <div>
        <h3>{title}</h3>
        <div class="sp-meta">
    ...
    <div class="sp-actions">
      <button class="sp-btn-primary" onclick={downloadPptx}><Icon name="arrow-down" size={16} /> DOWNLOAD .PPTX</button>
      {#if onClose}
        <button class="sp-btn-ghost" onclick={() => onClose && onClose()}><Icon name="x" size={16} /></button>
      {/if}
    </div>
  </header>
  ...
  {:else if error}
    <div class="sp-error"><Icon name="alert-triangle" size={16} /> {error}</div>
  {:else}
    <div class="sp-body">
          ...
          <div class="sp-slide-head">
            ...
            <div class="sp-slide-actions">
              ...
              <button class="sp-btn-link" disabled={regeneratingIdx !== null} onclick={() => openPrompt(i)} title="Rewrite with prompt">
                <Icon name="message-square" size={16} /> PROMPT
              </button>
              <button class="sp-btn-link" disabled={regeneratingIdx !== null} onclick={() => openEdit(i)}>(edit) EDIT</button>
            </div>
          </div>
          {#if promptIdx === i}
